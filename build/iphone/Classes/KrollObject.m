...
//@interface HellAndHeavenObject : NSObject
//@end

@interface HellAndHeavenObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HellAndHeavenObject class]])
		{
			for (NSString *key in [[(HellAndHeavenObject*)o modules] allKeys])
			{
