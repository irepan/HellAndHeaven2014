...
// in simulator we redefine to format for HellAndHeaven Developer console
...
{\
	NSString * exceptionName = [@"org.hellandheaven." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hellandheaven";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHellAndHeavenNativeItemNone = -1, 
	UIHellAndHeavenNativeItemSpinner = -2,
	UIHellAndHeavenNativeItemProgressBar = -3,
	
	UIHellAndHeavenNativeItemSlider = -4,
	UIHellAndHeavenNativeItemSwitch = -5,
	UIHellAndHeavenNativeItemMultiButton = -6,
	UIHellAndHeavenNativeItemSegmented = -7,
	
	UIHellAndHeavenNativeItemTextView = -8,
	UIHellAndHeavenNativeItemTextField = -9,
	UIHellAndHeavenNativeItemSearchBar = -10,
	
	UIHellAndHeavenNativeItemPicker = -11,
	UIHellAndHeavenNativeItemDatePicker = -12,
	
	UIHellAndHeavenNativeItemInfoLight = -13,
	UIHellAndHeavenNativeItemInfoDark = -14,
	
	UIHellAndHeavenNativeItemDisclosure = -15,
	
	UIHellAndHeavenNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all HellAndHeaven instances of
