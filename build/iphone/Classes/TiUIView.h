...
/**
 Base class for all HellAndHeaven views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the HellAndHeaven view hierarchy (such as wrapped iOS UIViews) was touched.
