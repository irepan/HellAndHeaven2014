...
//Rare exceptions to indicate a bug in the _hellandheaven code (Eg, function that a subclass should have implemented)
...
/**
 The base class for HellAndHeaven proxies.
 */
