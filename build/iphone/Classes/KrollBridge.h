...
@interface HellAndHeavenObject : KrollCoverageObject {
#else
@interface HellAndHeavenObject : KrollObject {
#endif
@private
...
extern NSString * HellAndHeaven$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HellAndHeavenObject *_hellandheaven;
    KrollObject* console;
	BOOL shutdown;
