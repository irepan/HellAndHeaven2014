(function(a) {
    ...
    function w(a) {
        var b;
        a._a && -2 === a._pf.overflow && (b = 0 > a._a[jb] || a._a[jb] > 11 ? jb : 1 > a._a[kb] || a._a[kb] > t(a._a[ib], a._a[jb]) ? kb : 0 > a._a[lb] || a._a[lb] > 23 ? lb : 0 > a._a[mb] || a._a[mb] > 59 ? mb : 0 > a._a[nb] || a._a[nb] > 59 ? nb : 0 > a._a[ob] || a._a[ob] > 999 ? ob : -1, 
    ...
    function K(a) {
        ...
        if (!a._d) {
            for (d = M(a), a._w && null == a._a[kb] && null == a._a[jb] && (f = function(b) {
                var c = parseInt(b, 10);
                return b ? 3 > b.length ? c > 68 ? 1900 + c : 2e3 + c : c : null == a._a[ib] ? db().weekYear() : a._a[ib];
            ...
            k = parseInt(g.w, 10) || 1, null != g.d && i._week.dow > j && k++, h = Z(f(g.gg), k, j, i._week.doy, i._week.dow)), 
    ...
    function N(a) {
        ...
        for (d = G(a._f, g).match(vb) || [], b = 0; d.length > b; b++) e = d[b], c = (h.match(H(e, a)) || [])[0], 
        ...
        a._pf.charsLeftOver = i - j, h.length > 0 && a._pf.unusedInput.push(h), a._isPm && 12 > a._a[lb] && (a._a[lb] += 12), 
    ...
    function Q(a) {
        ...
        for (f = 0; a._f.length > f; f++) g = 0, c = h({}, a), c._pf = b(), c._f = a._f[f], 
    ...
    for (db.normalizeUnits = function(a) {
        ...
        toISOString: function() {
            var a = db(this).utc();
            return a.year() > 0 && 9999 >= a.year() ? F(a, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]") : F(a, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]");
        },
        toArray: function() {
            var a = this;
        ...
        zone: function(a) {
            ...
            16 > Math.abs(a) && (a = 60 * a), this._offset = a, this._isUTC = !0, b !== a && l(this, db.duration(b - a, "m"), 1, !0), 
            this);
        },
        zoneAbbr: function() {
    ...
    }), eb = 0; Rb.length > eb; eb++) _(Rb[eb].toLowerCase().replace(/s$/, ""), Rb[eb]);
